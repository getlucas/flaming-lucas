...
if ($h != 'gmttt')
{
	print "body {align: center;text-align:center;font:Verdana,Helvertica,sans-serif;font-weight:900;};";
}
else
{
	print "body {align:center;text-align:center;font-size:25px;font:Verdana,Helvertica,sans-serif;font-weight:900;};";
}
?>
</style>
</head>
